...
function PanelGenerarReporte({ onGenerado }) {
  ...
  // F-R03 FIX: filtro por cultivo
  const cultivoNombreFiltro = sessionStorage.getItem("gv_cultivo_nombre") || "";
  ...
  const generar = async () => {
    ...
    try {
      const payload = {
        ...
        // F-R03 FIX: incluir nombre del cultivo activo como contexto del reporte
        nombre: nombre || (cultivoNombreFiltro ? `${tipo} - ${cultivoNombreFiltro}` : null),
      };
